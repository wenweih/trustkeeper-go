...
func makeSendETHTxHandler(m *http.ServeMux, endpoints endpoint.Endpoints, options []http1.ServerOption) {
	m.Handle("/send-ethtx", http1.NewServer(endpoints.SendETHTxEndpoint, decodeSendETHTxRequest, encodeSendETHTxResponse, options...))
}

// decodeSendETHTxRequest is a transport/http.DecodeRequestFunc that decodes a
// JSON-encoded request from the HTTP request body.
func decodeSendETHTxRequest(_ context.Context, r *http.Request) (interface{}, error) {
	req := endpoint.SendETHTxRequest{}
	err := json.NewDecoder(r.Body).Decode(&req)
	return req, err
}

// encodeSendETHTxResponse is a transport/http.EncodeResponseFunc that encodes
// the response as JSON to the response writer
func encodeSendETHTxResponse(ctx context.Context, w http.ResponseWriter, response interface{}) (err error) {
	if f, ok := response.(endpoint.Failure); ok && f.Failed() != nil {
		ErrorEncoder(ctx, f.Failed(), w)
		return nil
	}
...
// makeSendERC20TxHandler creates the handler logic
func makeSendERC20TxHandler(m *http.ServeMux, endpoints endpoint.Endpoints, options []http1.ServerOption) {
	m.Handle("/send-erc20tx", http1.NewServer(endpoints.SendERC20TxEndpoint, decodeSendERC20TxRequest, encodeSendERC20TxResponse, options...))
}

// decodeSendERC20TxRequest is a transport/http.DecodeRequestFunc that decodes a
// JSON-encoded request from the HTTP request body.
func decodeSendERC20TxRequest(_ context.Context, r *http.Request) (interface{}, error) {
	req := endpoint.SendERC20TxRequest{}
	err := json.NewDecoder(r.Body).Decode(&req)
	return req, err
}

// encodeSendERC20TxResponse is a transport/http.EncodeResponseFunc that encodes
// the response as JSON to the response writer
func encodeSendERC20TxResponse(ctx context.Context, w http.ResponseWriter, response interface{}) (err error) {
	if f, ok := response.(endpoint.Failure); ok && f.Failed() != nil {
		ErrorEncoder(ctx, f.Failed(), w)
		return nil
	}
...
// makeSendOmniTxHandler creates the handler logic
func makeSendOmniTxHandler(m *http.ServeMux, endpoints endpoint.Endpoints, options []http1.ServerOption) {
	m.Handle("/send-omni-tx", http1.NewServer(endpoints.SendOmniTxEndpoint, decodeSendOmniTxRequest, encodeSendOmniTxResponse, options...))
}

// decodeSendOmniTxRequest is a transport/http.DecodeRequestFunc that decodes a
// JSON-encoded request from the HTTP request body.
func decodeSendOmniTxRequest(_ context.Context, r *http.Request) (interface{}, error) {
	req := endpoint.SendOmniTxRequest{}
	err := json.NewDecoder(r.Body).Decode(&req)
	return req, err
}

// encodeSendOmniTxResponse is a transport/http.EncodeResponseFunc that encodes
// the response as JSON to the response writer
func encodeSendOmniTxResponse(ctx context.Context, w http.ResponseWriter, response interface{}) (err error) {
	if f, ok := response.(endpoint.Failure); ok && f.Failed() != nil {
		ErrorEncoder(ctx, f.Failed(), w)
		return nil
	}
