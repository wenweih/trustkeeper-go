...
func MakeQueryBalanceEndpoint(s service.WebapiService) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		req := request.(QueryBalanceRequest)
		balance, err := s.QueryBalance(ctx, req.Symbol, req.Address)
		if err != nil {
			return QueryBalanceResponse{Err: err}, err
		}
...
func MakeWalletValidateEndpoint(s service.WebapiService) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
