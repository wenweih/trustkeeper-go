...
type AccountService interface {
	...
	Auth(ctx context.Context) (accountuid string, namespaceid string, err error)
	Close() error
}
...
func (b *basicAccountService) Auth(ctx context.Context) (accountuid string, namespaceid string, err error) {
	tokenID, err := extractTOkenIDFromContext(ctx, b.jwtKey)
	if err != nil {
		return "", "", err
	}
