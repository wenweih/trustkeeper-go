...
type IBiz interface {
	Signup(email, password, orgName string) (uid, namespaceid, role string, err error)
...
func (repo *repo) Signup(email, password, orgName string) (uid, namespaceID, role string, err error) {
	...
	return uuid.String(), namespaceID, account_const.MerchantAdmin, nil
}
