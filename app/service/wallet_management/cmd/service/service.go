...
var grpcAddr = fs.String("grpc-addr", ":5555", "gRPC listen address")
...
func Run() {
	...
	registrar, err := etcd.RegisterService(conf.EtcdServer, common.WalletManagementSrv, conf.Instance, logger)
	if err != nil {
		logger.Log("WalletManagementSrv registrar error: ", err.Error())
		return
	}
