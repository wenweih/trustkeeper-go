...
func (b *basicWalletManagementService) CreateWallet(ctx context.Context, groupid string, chainname string, bip44change int) (err error) {
	err = b.biz.CreateWallet(ctx, groupid, chainname, bip44change)
	return
}
